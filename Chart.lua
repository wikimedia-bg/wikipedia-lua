...
function barChart( frame )
    ...
    function drawYScale()
        function drawSingle( gi, color, width, single )
            ...
            local valStyleStr =
                ...
                or 'position:absolute;height=20px;text-align:right;vertical-align:middle;width:%spx;top:%spx;left:3px;background-color:%s;color:white;font-weight:bold;word-break:keep-all;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000;padding:0 2px'
    ...
    function drawXlegends()
        ...
        local legendDivStyleFormat = "position:absolute;left:%spx;top:10px;min-width:%spx;text-align:center;vertical-align:top;"
