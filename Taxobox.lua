...
local TAXONOMICRANK = {
	...
	Q334460 = { id = 9, name = 'отдел', ignore = false },
	Q1153785 = { id = 10, name = 'подтип', ignore = true },
	Q3491997 = { id = 11, name = 'подотдел', ignore = true },
	Q2361851 = { id = 12, name = 'инфратип', ignore = true },
	Q3504061 = { id = 13, name = 'надклас', ignore = true },
	Q60922428 = { id = 14, name = 'мегаклас', ignore = true },
	Q37517 = { id = 15, name = 'клас', ignore = false },
	Q5867051 = { id = 16, name = 'подклас', ignore = true },
	Q2007442 = { id = 17, name = 'инфраклас', ignore = true },
	Q6054237 = { id = 18, name = 'magnorder', ignore = true },
	Q5868144 = { id = 19, name = 'надразред', ignore = true },
	Q6462265 = { id = 20, name = 'grandorder', ignore = true },
	Q7506274= { id = 21, name = 'mirorder', ignore = true },
	Q36602 = { id = 22, name = 'разред', ignore = false },
	Q5867959 = { id = 23, name = 'подразред', ignore = true },
	Q2889003 = { id = 24, name = 'инфраразред', ignore = true },
	Q6311258= { id = 25, name = 'parvorder', ignore = true },
	Q2136103 = { id = 26, name = 'надсемейство', ignore = true },
	Q35409 = { id = 27, name = 'семейство', ignore = false },
	Q164280 = { id = 28, name = 'подсемейство', ignore = true },
	Q14817220 = { id = 29, name = 'надтриб', ignore = true },
	Q227936 = { id = 30, name = 'триб', ignore = false },
	Q3965313 = { id = 31, name = 'подтриб', ignore = true },
	Q34740 = { id = 32, name = 'род', ignore = false },
	Q3238261 = { id = 33, name = 'подрод', ignore = true },
	Q3181348 = { id = 34, name = 'секция', ignore = false },
	Q7432 = { id = 35, name = 'вид', ignore = false },
	Q68947 = { id = 36, name = 'подвид', ignore = false },
	Q767728 = { id = 37, name = 'вариетет', ignore = false },
	Q713623 = { id = 38, name = 'клон', ignore = false },
	Q855769 = { id = 39, name = 'щам', ignore = false }
}
