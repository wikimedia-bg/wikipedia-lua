...
local THEMES = {
	...
	{ 'наука', 'Science-symbol-2.svg' },
		...
		{ 'електротехника|енергетика|ядрена енергетика', 'Transformer-hightolow-ironcore.png' },
		...
		{ 'техника|технология|инженерство|радио|интернет|далекосъобщения|телекомуникации|комуникация|телевизия|авиация', 'Spur Gear 12mm, 18t.svg' },
