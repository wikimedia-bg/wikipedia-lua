...
local THEMES = {
	...
	{ 'наука', 'Science-symbol-2.svg' },
		...
		{ 'символ|знак', 'फ् कारः.jpg', 'символи' },
		{ 'социална група|общност', 'Society.png', 'социални групи' },
		{ 'техника|технология|инженерство|радио|интернет|далекосъобщения|телекомуникации|комуникация|телевизия|авиация|електроника|електротехника|енергетика|ядрена енергетика', 'Spur Gear 12mm, 18t.svg' },
		{ 'търговия', 'CashRegister.svg' },
		{ 'устройство|машина|апарат|уред|инструмент', 'Spur Gear 12mm, 18t.svg', 'устройства' },
			{ 'електрическо устройство|хардуер|изчислителна техника|компютър|компютри|комп', 'Elektryk MW - zawodowy.png', 'електрически устройства' },
			{ 'архитектурен елемент|строителен елемент|помещение', 'Corinthian_capital.png', 'строителни елементи' },
	...
	{ 'човек|личност', 'Crystal Clear app Login Manager.png', 'хора' },
		...
		{ 'човек на изкуството|цирков артист', 'Arts and Culture - The Noun Project.svg', 'хора на изкуството' },
	...
	{ 'телевизионен канал', 'Television icon.svg', 'телевизионни канали' },
