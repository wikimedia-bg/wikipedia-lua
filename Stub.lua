...
local THEMES = {
	...
	{ 'наука', 'Science-symbol-2.svg' },
		...
		{ 'техника|технология|инженерство|радио|интернет|далекосъобщения|телекомуникации|комуникация|телевизия', 'Spur Gear 12mm, 18t.svg' },
		{ 'търговия', 'CashRegister.svg' },
		{ 'устройство|машина|апарат|уред|инструмент', 'Spur Gear 12mm, 18t.svg', 'устройства' },
			{ 'електрическо устройство', 'Elektryk MW - zawodowy.png' },
