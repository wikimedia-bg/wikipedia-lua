...
local THEMES = {
	...
	-- НАУКА
	{ 'Германия-история', 'Berlin Brandenburger Tor BW 2 Ausschnitt.jpg' },
	{ 'САЩ-история', 'Washington_Crossing_the_Delaware_by_Emanuel_Leutze,_MMA-NYC,_1851.jpg' },
	...
	-- ХОРА
	{ 'Австрийски актьор', 'Austria film clapperboard.png' },
	{ 'Архитект', 'Baumeister - Holzschnitt von Jost Amman - 1536.svg' },
	{ 'Германия-писател', 'Flag of Germany.svg' },
	...
	{ 'изследовател', 'Marco Polo portrait.jpg' },
	...
	{ 'нидерландски художник', 'Self-portrait_at_34_by_Rembrandt.jpg' },
	...
	{ 'философ', 'Head Platon Glyptothek Munich 548.jpg' },
	...
	{ 'вулкан', 'Noto Project Volcano Emoji.svg' },
	...
	{ 'изкуствен спътник', 'Nasa swift satellite.jpg' },
	...
	{ 'музикален инструмент', 'Saxophone-icon.svg' },
